...
import com.noctambulist.foody.databinding.FragmentUserAccountBinding
import com.noctambulist.foody.dialogbox.setupBottomSheetDialog
import com.noctambulist.foody.util.Resource
import com.noctambulist.foody.viewmodel.UserAccountViewModel
...
class UserAccountFragment : Fragment() {
    ...
    private lateinit var imageActivityResulstLauncher: ActivityResultLauncher<Intent>
    private lateinit var lottieLoading: LottieAnimationView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        imageActivityResulstLauncher =
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imageEdit.setOnClickListener {
            ...
            intent.type = "image/*"
            imageActivityResulstLauncher.launch(intent)
        }
    }
